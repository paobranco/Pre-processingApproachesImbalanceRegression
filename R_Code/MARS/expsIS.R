    ...
    assign(resObj,
           try(
             performanceEstimation(
               myDSs[d],
               c(Workflow('WFnone_earth_nk10_d1', learner=w),
                 Workflow('WFnone_earth_nk10_d2', learner=w),
                 Workflow('WFnone_earth_nk17_d1', learner=w),
                 Workflow('WFnone_earth_nk17_d2', learner=w),
                 do.call('workflowVariants', 
                         c(list('WFRU_earth_nk10_d1',
                                learner=w,
